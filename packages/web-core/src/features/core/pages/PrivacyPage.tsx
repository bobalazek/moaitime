...
export default function PrivacyPage() {
  useEffect(() => {
    document.title = 'Privacy | MoaiTime';
  }, []);
    ...
    <div className="flex h-full flex-col items-center justify-center p-5">
      <div className="prose w-full max-w-4xl">
        ...
        <p>
          ...
          <a href="https://moaitime.com">https://moaitime.com</a>, and other sites we own and
          operate.
        </p>
        <p>
        ...
        <p>This policy is effective as of 20 February 2024.</p>
        <p>Last updated: 20 February 2024</p>
        ...
        <p>
          The personal information we collect is stored and/or processed in Germany, or where we or
        ...
        <p>
          ...
          information on behalf of other organizations (known as “data processors”). We, MoaiTime,
        ...
        <h4>Google Data</h4>
        <p>
          MoaiTime's use and transfer of information received from Google APIs to any other app will
          adhere to{' '}
        ...
        <p>
          ...
          may consent to providing your name and contact details for the purpose of entering a
          giveaway or promotion. While you may withdraw your entry at any time, this will not affect
          any selection or judging that has already taken place. If you have any further enquiries
