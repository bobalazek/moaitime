...
const TaskActions = memo(({ task, onEditAndFocus }: { task: TaskInterface; onEditAndFocus: () => void }) => {
  ...
  return (
    <div className="absolute right-0 top-0 ml-2">
      <DropdownMenu open={dropdownMenuOpen} onOpenChange={setDropdownMenuOpen}>
        ...
        <DropdownMenuContent className="w-56 bg-gray-700" align="end" data-test="tasks--task--actions-dropdown-menu">
          <DropdownMenuGroup>
            <DropdownMenuItem
